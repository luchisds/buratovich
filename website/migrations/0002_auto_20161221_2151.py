# -*- coding: utf-8 -*-
# Generated by Django 1.9.11 on 2016-12-22 00:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange_rate_adjustment_date', models.DateField(verbose_name='Fecha Ajuste de Cambio')),
                ('date_1', models.DateField(verbose_name='Fecha 1')),
                ('date_2', models.DateField(verbose_name='Fecha 2')),
        ...
        migrations.AlterField(
            model_name='user',
            name='algoritmo_code',
            field=models.IntegerField(verbose_name='Cuenta Algoritmo'),
        ),
    ]
